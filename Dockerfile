...
ENV		_BUILD_DEPS	libgdal-dev gdal-bin python-gdal libgrib-api-dev libproj-dev libblas-dev liblapack-dev gfortran g++ libjson-c-dev wget make

ADD		requirements.txt	/
RUN		apt-get update \
	&&	apt-get install -yqq --no-install-recommends software-properties-common python-software-properties python-pip \
	...
	&&	CPLUS_INCLUDE_PATH=/usr/include/gdal C_INCLUDE_PATH=/usr/include/gdal pip install GDAL==1.11.1 \
